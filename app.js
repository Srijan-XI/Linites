...
(function initMockWindow() {
    ...
    const APPS = [
        /* Development */
        { id: 'vscode', cat: 'dev', icon: '<img src="img/assets/vscode/vscode-auto.svg" class="mock-app-icon">', name: 'VS Code', checked: true },
        { id: 'docker', cat: 'dev', icon: '<img src="img/assets/docker.svg" class="mock-app-icon">', name: 'Docker', checked: true },
        { id: 'git', cat: 'dev', icon: '<img src="img/assets/git/git-auto.svg" class="mock-app-icon">', name: 'Git', checked: true },
        { id: 'nodejs', cat: 'dev', icon: '<img src="img/assets/nodejs/nodejs-auto.svg" class="mock-app-icon">', name: 'Node.js', checked: false },
        { id: 'python', cat: 'dev', icon: '<img src="img/assets/python/python-auto.svg" class="mock-app-icon">', name: 'Python 3', checked: false },
        { id: 'pycharm', cat: 'dev', icon: '🧠', name: 'PyCharm', checked: false },
        { id: 'postman', cat: 'dev', icon: '<img src="img/assets/postman/postman-auto.svg" class="mock-app-icon">', name: 'Postman', checked: false },
        { id: 'neovim', cat: 'dev', icon: '<img src="img/assets/neovim/neovim-auto.svg" class="mock-app-icon">', name: 'Neovim', checked: false },
        { id: 'github-cli', cat: 'dev', icon: '<img src="img/assets/gh/gh-auto.svg" class="mock-app-icon">', name: 'GitHub CLI', checked: false },
        { id: 'kubectl', cat: 'dev', icon: '<img src="img/assets/kubectl/kubectl-auto.svg" class="mock-app-icon">', name: 'kubectl', checked: false },

        /* Media */
        { id: 'vlc', cat: 'media', icon: '<img src="img/assets/vlc/vlc.svg" class="mock-app-icon">', name: 'VLC', checked: false },
        { id: 'obs', cat: 'media', icon: '<img src="img/assets/obs/obs-auto.svg" class="mock-app-icon">', name: 'OBS Studio', checked: true },
        { id: 'gimp', cat: 'media', icon: '<img src="img/assets/gimp/gimp-auto.svg" class="mock-app-icon">', name: 'GIMP', checked: false },
        { id: 'blender', cat: 'media', icon: '<img src="img/assets/blender/blender-auto.svg" class="mock-app-icon">', name: 'Blender', checked: false },
        { id: 'inkscape', cat: 'media', icon: '<img src="img/assets/inkscape/inkscape-auto.svg" class="mock-app-icon">', name: 'Inkscape', checked: false },
        { id: 'audacity', cat: 'media', icon: '<img src="img/assets/audacity/audacity-auto.svg" class="mock-app-icon">', name: 'Audacity', checked: false },
        { id: 'kdenlive', cat: 'media', icon: '<img src="img/assets/kdenlive/kdenlive-auto.svg" class="mock-app-icon">', name: 'Kdenlive', checked: false },
        { id: 'spotify', cat: 'media', icon: '<img src="img/assets/spotify/spotify-auto.svg" class="mock-app-icon">', name: 'Spotify', checked: false },

        /* Utilities */
        { id: 'firefox', cat: 'util', icon: '<img src="img/assets/firefox/firefox-auto.svg" class="mock-app-icon">', name: 'Firefox', checked: false },
        { id: 'chromium', cat: 'util', icon: '<img src="img/assets/chromium/chromium-auto.svg" class="mock-app-icon">', name: 'Chromium', checked: false },
        { id: 'telegram', cat: 'util', icon: '<img src="img/assets/telegram.svg" class="mock-app-icon">', name: 'Telegram', checked: true },
        { id: 'thunderbird', cat: 'util', icon: '<img src="img/assets/thunderbird/thunderbird-auto.svg" class="mock-app-icon">', name: 'Thunderbird', checked: false },
        { id: 'zoom', cat: 'util', icon: '<img src="img/assets/zoom/zoom-auto.svg" class="mock-app-icon">', name: 'Zoom', checked: false },
        { id: 'timeshift', cat: 'util', icon: '<img src="img/assets/timeshift/timeshift-auto.svg" class="mock-app-icon">', name: 'Timeshift', checked: false },
        { id: 'flameshot', cat: 'util', icon: '<img src="img/assets/flameshot.svg" class="mock-app-icon">', name: 'Flameshot', checked: false },
        { id: 'keepassxc', cat: 'util', icon: '<img src="img/assets/keepassxc/keepassxc-auto.svg" class="mock-app-icon">', name: 'KeePassXC', checked: false },
        ...
        /* Security */
        { id: 'nmap', cat: 'sec', icon: '<img src="img/assets/nmap/nmap-auto.svg" class="mock-app-icon">', name: 'Nmap', checked: false },
        { id: 'wireshark', cat: 'sec', icon: '<img src="img/assets/wireshare/wireshark-auto.svg" class="mock-app-icon">', name: 'Wireshark', checked: true },
        { id: 'metasploit', cat: 'sec', icon: '<img src="img/assets/metasploit/metasploit-auto.svg" class="mock-app-icon">', name: 'Metasploit', checked: false },
        { id: 'hashcat', cat: 'sec', icon: '<img src="img/assets/hashcat/hashcat-auto.svg" class="mock-app-icon">', name: 'Hashcat', checked: false },
        { id: 'burpsuite', cat: 'sec', icon: '<img src="img/assets/burp/burpsuite-auto.svg" class="mock-app-icon">', name: 'Burp Suite', checked: false },
        { id: 'john', cat: 'sec', icon: '<img src="img/assets/john/john-auto.svg" class="mock-app-icon">', name: 'John the Ripper', checked: false },
        { id: 'aircrack', cat: 'sec', icon: '<img src="img/assets/aircrack-ng/aircrack-ng-auto.svg" class="mock-app-icon">', name: 'Aircrack-ng', checked: false },
    ];
